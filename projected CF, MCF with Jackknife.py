...
#This code compute projected correlation function and projected marked correlation function(w_p,m_p) of galaxies using ra,dec,z!
#To use this code, you should first convert ra,dec,z into X,Y,Z! See convert celestial coordinate to cartesian!
